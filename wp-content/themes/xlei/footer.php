<footer>
    <div class="copyright">
        <div class="container">
            <div class="col-8">
                <div class="site-info">版权所有 © 2017 - 2018
				    <a href="<?php echo home_url(); ?>">
				        <?php bloginfo('name'); ?>
				    </a>
				    <span class="sep">|</span>
				    <a href="https://cn.wordpress.org/" target="_blank">Powered by workpress</a>
				    <span class="sep">|</span><a href="http://littlewin.info/" target="_blank">Design By littlewin</a><span class="sep">|</span>
				    <a href="<?php echo home_url(); ?>">Code by xlei</a>
				</div>
			</div>
            <div class="col-4">
